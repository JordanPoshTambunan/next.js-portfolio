        ...
        <div>
            ...
            <ScrollReveal stagger={0.12} className='grid grid-cols-1 md:grid-cols-2 items-center'>
                <div className='relative -pl-50 z-10'>
                    ...
                    {/* description */}
                    <div className='relative md:-mr-24 md:-mt-6 z-20 max-w-5xl rounded-2xl p-5 bg-white/6 backdrop-blur-sm border border-white/10 shadow-[0_6px_50px_rgba(48,90,208,0.25)]'>
                    ...
                    <div className='mt-6 ml-2 flex justify-start space-x-3 text-white/60 text-xs'>
                        <span className='px-2 py-1 rounded-full border border-white/10 bg-white/5'>BurpSuite</span>
                        <span className='px-2 py-1 rounded-full border border-white/10 bg-white/5'>LFI</span>
            ...
            <ScrollReveal stagger={0.14} delay={0.8} className='grid grid-cols-1 md:grid-cols-2 items-center'>
                ...
                <div className='relative md:order-2 z-10'>
                    ...
                    <div className='mb-12 text-right'>
                        <p className='text-xs text-[#7ba3e0]'>Web &amp; Mobile Pentest · 2025</p>
                        <h3 className='text-2xl md:text-3xl font-semibold text-white/90'>Penetration Testing Portfolio</h3>
                    </div>

                    {/* description */}
                    <div className='relative md:-ml-24 md:-mt-6 z-20 max-w-5xl rounded-2xl p-5 bg-white/6 backdrop-blur-sm border border-white/10 shadow-[0_6px_50px_rgba(48,90,208,0.25)]'>
                        <p className='text-sm p-4 text-white/75'>Conducted comprehensive penetration testing on multiple web applications (mola.tv, analisacademy.com, simak-ng.unud.ac.id) and mobile applications (Gasabsence, Mola) using OWASP Top 10 methodology. Utilized BurpSuite, MobSF, and Wireshark for vulnerability identification, exploitation, and detailed reporting with remediation recommendations.</p>
                        <div className="pointer-events-none absolute -inset-px rounded-[14px] opacity-60"
                        style={{
                            background: 'linear-gradient(135deg, rgba(48, 90, 208, 0.35), rgba(48, 90, 208, 0.05))',
                        }}
                    ...
                    <div className='mt-6 ml-2 flex justify-end space-x-3 text-white/60 text-xs'>
                        <span className='px-2 py-1 rounded-full border border-white/10 bg-white/5'>OWASP</span>
                        <span className='px-2 py-1 rounded-full border border-white/10 bg-white/5'>MobSF</span>
                        <span className='px-2 py-1 rounded-full border border-white/10 bg-white/5'>Pentest</span>
                    </div>
                </div>
                ...
                <div className='relative md:order-1'>
                    <div tabIndex={0} className='group cursor-pointer rounded-2xl overflow-hidden bg-[#060d1f] border border-[#1c2d55] shadow-[0_0_90px_rgba(48,90,208,0.28)] transition-transform duration-300 hover:-translate-y-1 focus:-translate-y-1'>
                        <div className='overflow-hidden md:h-[360px] h-[250px]'>
                            <Image src="/images/Portfolio.png" alt='project-2' width={582} height={640} className='w-full h-auto transition-transform duration-3500 ease-linear group-hover:-translate-y-[55%] group-active:-translate-y-[55%] group-focus:-translate-y-[55%]'/>
                        </div>
                    </div>
                </div>
            </ScrollReveal>
